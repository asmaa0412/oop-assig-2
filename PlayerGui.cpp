...
PlayerGui::PlayerGui()
{
    ...
    for (auto* btn : { &loadButton, &playButton, &pauseButton, &goToStartButton, &goToEndButton, &muteButton, &loopButton })
    {
...
void PlayerGui::resized()
{
    ...
    y += 40;
    metadataLabel.setBounds(10, y, getWidth() - 20, 30);

    y += 40;
    playlistBox.setBounds(10, y, getWidth() - 20, 120);
}
...
void PlayerGui::buttonClicked(juce::Button* button)
{
    ...
    else if (button == &playButton)
    {
        ...
        {
            playerAudio.LoadFile(playlistFiles[selectedRow]);
